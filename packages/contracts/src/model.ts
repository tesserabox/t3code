...
const LEGACY_COPILOT_DRIVER_KIND = ProviderDriverKind.make("copilot");
...
export const DEFAULT_MODEL_BY_PROVIDER: Partial<Record<ProviderDriverKind, string>> = {
  ...
  [COPILOT_DRIVER_KIND]: "gpt-5.4",
  [LEGACY_COPILOT_DRIVER_KIND]: "gpt-5.4",
...
export const PROVIDER_DISPLAY_NAMES: Partial<Record<ProviderDriverKind, string>> = {
  ...
  [LEGACY_COPILOT_DRIVER_KIND]: "GitHub Copilot",
