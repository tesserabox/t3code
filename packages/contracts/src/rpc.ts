...
export const WS_METHODS = {
  ...
  serverSetSkillEnabled: "server.setSkillEnabled",
...
export const WsServerSetSkillEnabledRpc = Rpc.make(WS_METHODS.serverSetSkillEnabled, {
  payload: Schema.Struct({
